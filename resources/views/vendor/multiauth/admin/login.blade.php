...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="{{asset('public/assets/app-assets/css/pages/authentication.css')}}">
   <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{asset('public/assets/app-assets/images/pages/login.png')}}" alt="branding logo">
                                </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form method="POST" action="{{ route('admin.login') }}">
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left">
                                                        <input type="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}"  name="password" id="user-password" placeholder="Password" required autocomplete="current-password">
                                                        <div class="form-control-position">
